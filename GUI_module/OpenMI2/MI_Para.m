...
Dat=zeros(buffer_size, size(1:32,2)); % 1:32 ä�� �ε��� �̰�...
% �ʿ��� Ʈ���� �� �� ��ŭ �����ְ� �� ����� ���ư����� Ȯ��...�ϴ� ����ε�...
% �ڱ��� ������ �޾ƿ���
% waitSecs�� 0.5 �� �؇J�µ�... �����....
qwe=0;
% ppWrite(IO_ADDR,111);WaitSecs(0.5); % ���� Ʈ���� ����
[data, markertime, markerdescr, state] = bbci_acquire_bv(state);
if markerdescr==111
    qwe=qwe+1;
end

% ppWrite(IO_ADDR,5);WaitSecs(0.5); % �߰��� +?beep? �� ���� Ʈ���� ����
[data, markertime, markerdescr, state] = bbci_acquire_bv(state);
if markerdescr==5
    qwe=qwe+1;
end

% ppWrite(IO_ADDR,222);WaitSecs(0.5); % ������ Ʈ���� ����
[data, markertime, markerdescr, state] = bbci_acquire_bv(state);
if markerdescr==222
    qwe=qwe+1;
end
